	      	...
	      	<div class="navbar-inner">
          		<div class="nav-collapse collapse">
            		<ul class="nav">
              			...
              			<li><a href="index.php/teacher/quit" id="quit"><i class="icon-off"></i> 退出登录</a></li>
            		</ul>
          		</div>	
	      	</div>
	    </div>
  		...
  		<div class="personal_info">
				<div class="row-fluid">
					...
					<div class="span8 teacher_info">
						<legend><h3><a href="" class="teacher_name"><?php echo $teacherinfo[0]->username;?> 导师</a></h3></legend>
				...
				<ul class="list-body">
					...
					<?php foreach ($studentmaster as $key => $value): ?>
						<li class="student btn" id="<?php echo $value->studentid;?>">
							<a class="" href="index.php/teacher/detail/<?php echo $value->studentid;?>" target="">

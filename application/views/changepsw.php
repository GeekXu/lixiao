	      	...
	      	<div class="navbar-inner">
          		<div class="nav-collapse collapse">
            		<ul class="nav">
              			...
              			<li class="active"><a href="index.php/teacher/changepsw" id="changepsw"><i class="icon-wrench "></i> 修改密码</a></li>
	...
	<script type="text/javascript">
		$(document).ready(function(){
			$('#doChangePsw').click(function(){
				...
				$.post("index.php/teacher/doChangePsw",{oriPsw: oriPsw, newPsw: newPsw},function(d){
					//alert(d);

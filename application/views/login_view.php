			...
			<div class="span3">
				<div >
			      	<form class="form-signin">
				        ...
				        <input type="text" id="login_name" class="input-block-level" placeholder="用户名" required>
				        <input type="password" id="login_psw" class="input-block-level" placeholder="密码" required>
